...
class ShanGeTu():
    # def __init__(self,map_data,start_point=[7,0],end_point=[20,16]):   ### 从左上角到右下角的hzau地图LPA路径
    def __init__(self,map_data,start_point=[14, 1],end_point=[7,14]):     ### 从左下角到右上角的hzau地图LPA路径
    ...
    # def __draw_barrier(self,start_point=[7,0],end_point=[20,16]):                      ###############这里也不需要修改，就是画禁忌点的
    def __draw_barrier(self,start_point=[14,1],end_point=[7,14]):   ### 从左下角到右上角的hzau地图LPA路径
    ...
    def draw_way(self,way_data,new_pic = True,color = [0, 255, 0],line_type = '-'):
        if new_pic == True:
