from MIBSA_aco_demo import ACO    ################################注意看这里用的第几代
from MIBSA_draw_demo import ShanGeTu,IterationGraph    #导入栅格图、迭代图的绘制模块
...
# sfig.save('路径图+MIBSA_duoditu_demo_2.jpg')                   #保存栅格图数据为'123.jpg'  ### 从左上角到右下角的一般性地图LPA路径
sfig.save('路径图+MIBSA_duoditu_reverse_demo_1.jpg')                   #保存栅格图数据为'123.jpg'   ### 从左下角到右上角的一般性地图LPA路径
...
# dfig.save('迭代图+MIBSA_duoditu_demo_2.jpg')                     #迭代图保存为321.jpg    ### 从左上角到右下角的一般性地图LPA路径
dfig.save('迭代图+MIBSA_duoditu_reverse_demo_1.jpg')                     #迭代图保存为321.jpg   ### 从左下角到右上角的一般性地图LPA路径
