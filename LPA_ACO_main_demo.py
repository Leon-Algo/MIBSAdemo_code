from LPA_ACO_aco_demo import ACO    ################################注意看这里用的第几代
from LPA_ACO_draw_demo import ShanGeTu,IterationGraph    #导入栅格图、迭代图的绘制模块
...
# file = open('./route_list_4diriction_duoditu.txt', 'r')   ### 从左上角到右下角的一般性地图LPA路径  start = (0, 0) goal = (14,15)
file = open('./route_list_4diriction_duoditu_reverse.txt', 'r')   ### 从左下角到右上角的一般性地图LPA路径  start = (15, 0) goal = (0,12)
route_load = []
...
# sfig.save('路径图+LPA+ACO_duoditu_demo_2.jpg')                   #保存栅格图数据为'123.jpg'    ### 从左上角到右下角的一般性地图LPA路径
sfig.save('路径图+LPA+ACO_duoditu_reverse_demo_1.jpg')                   #保存栅格图数据为'123.jpg'   ### 从左下角到右上角的一般性地图LPA路径
...
# dfig.save('迭代图+LPA+ACO_duoditu_demo_2.jpg')                     #迭代图保存为321.jpg    ### 从左上角到右下角的一般性地图LPA路径
dfig.save('迭代图+LPA+ACO_duoditu_reverse_demo_1.jpg')                     #迭代图保存为321.jpg   ### 从左下角到右上角的一般性地图LPA路径
